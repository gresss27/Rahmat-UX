...
public class MoneyDonationVirtualAccountDetail2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_money_donation_virtual_account_detail2);
...
//        BALANCE
        ...
        View.OnClickListener goToTopUpActivity = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MoneyDonationVirtualAccountDetail2Activity.this, MoneyDonationActivity.class);
