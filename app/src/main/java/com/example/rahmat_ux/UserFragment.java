...
public class UserFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editProfile.setOnClickListener(v -> {
            ...
            intent.putExtra(EXTRA_UPDATED_USER, UserStorage.getInstance().getLoggedInUser());
            startActivityForResult(intent, REQUEST_CODE_EDIT_PROFILE);
        });

        // Kolom donasi yang belum selesai
        column1.setOnClickListener(v ->
                startActivity(new Intent(getActivity(), MenungguPenyelesaianActivity.class))
        );

        // Kolom status donasi
        column2.setOnClickListener(v ->
                startActivity(new Intent(getActivity(), StatusDonasiActivity.class))
        );
    ...
    public void onResume() {
        super.onResume();
        // Auto refresh setiap kali fragment kembali aktif
        updateProfileUI();
    }
    ...
    private void updateProfileUI() {
        ...
        if (currentUser == null) {
            // Kalau user belum login, tampilkan default
            userNameTextView.setText("Guest");
            userEmailTextView.setText("-");
            userJobTextView.setText("-");
        ...
        userJobTextView.setText(currentUser.getPekerjaan());

        String imageUri = currentUser.getProfileImageUri();
        ...
        // Update balance kalau ada
        TextView totalBalanceValue = requireView().findViewById(R.id.totalBalanceValue);
        totalBalanceValue.setText(formatCurrency(String.valueOf(currentUser.getBalance())));
    }
